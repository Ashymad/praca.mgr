...
\begin{enumerate}
  \item Mając wektor początkowy $\bm x$ o długość $N$, należy wyznaczyć wektor
    ...
    elementów wektora $\bm x$, tak że \begin{equation}
      ...
      \end{cases}
    \end{equation}
  \item Należy powtarzać krok pierwszy zastępujać wektor początkowy wektorem
...
zmniejsza ilość operacji logarytmowania potrzebnch do wyliczenia
...
operację w czasie cztery razy krótszym niż algorytm ,,naiwny''.
\begin{figure}[!tbh]
  \centering
