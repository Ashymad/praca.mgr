...
około \SI{1.7}{\mebi\byte}, dla porównania nieskompresowane pliki tekstowe
\LaTeX\ potrzebne do skompilowania tej pracy wraz ze schematami i wykresami
zajmuje zaledwie \SI{0.4}{\mebi\byte}) w porównaniu do innego typu plików
...
\begin{figure}[!tbh]
  \centering
  \includegraphics[width=\textwidth]{plots/model_c.pgf}
  \caption{Iden}
  \label{fig:model_c}
\end{figure}
\begin{table}[!tbh]
...
\begin{figure}[!tbh]
  \centering
  \includegraphics[width=\textwidth]{plots/model_c_t.pgf}
  \caption{Iden}
  \label{fig:model_c_t}
\end{figure}
\begin{table}[!tbh]
...
\begin{figure}[!tbh]
  \centering
  \includegraphics[width=\textwidth]{plots/model_c_t+p.pgf}
  \caption{Iden}
