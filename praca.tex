...
\begin{enumerate}
  \item Wybranie fragmentu o długości $L$ z sygnału audio, przy czym im dłuższy
    fragment tym czas analizy będzie dłuższy natomiast wynik dokładniejszy. Z
    badań wywnioskowano że odpowiednia długość fragmentu zawiera się w
    przedziale od dziesięciu do trzydziestu sekund.
\end{enumerate}
\subsection{MDCT}
